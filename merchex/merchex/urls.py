...
urlpatterns = [
    ...
    path("band/<int:band_id>/change", views.band_update, name='band-update'),
    ...
    path("listing/<int:listing_id>/change", views.listing_update, name='listing-update'),
    path("listing/<int:listing_id>/delete", views.listing_delete, name='listing-delete'),
    path("listing/add/", views.listing_create, name='add-listing'),
